...
const cases = [
  ['explicit wins over everything',
   { NEXT_PUBLIC_APP_URL: 'https://orders.iqsportsupply.com', VERCEL_URL: 'x.vercel.app' },
   'https://orders.iqsportsupply.com'],
  ['trailing slash trimmed',
   { NEXT_PUBLIC_APP_URL: 'https://orders.iqsportsupply.com/' },
   'https://orders.iqsportsupply.com'],

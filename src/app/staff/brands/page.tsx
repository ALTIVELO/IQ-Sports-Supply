...
export default async function BrandsPage() {
  ...
  const [{ data: brands }, { data: partners }, products] = await Promise.all([
    sb.from('brands').select('id, key, name, consignment, shows_margin').order('name'),
